    ...
    <>
      <Grid container>
        <List>
          ...
          <Content data={`84) Broadband Terahertz characterization of Graphene Oxide films fabricated on flexible substrates, Shreeya Rane, Avinash Kothuru, Arun Jana, Koijam Monika Devi, Sanket Goel, Shriganesh Prabhu, Dibakar Roy Chowdhury, Optical Materials, 125, 112045 (2022)`} />
          <Content data={`83) Phase Engineered Hybrid Terahertz Metasurfaces, Sukhvinder Kaur, Subhajit Karmakar, Arun Jana, Shreeya Rane, Ravendra Varshney, and Dibakar Roy Chowdhury, iScience, 25, 104024 (2022)`} />
          <Content data={`82) Graphene and metal hybridized terahertz metasurfaces toward tunable plasmon-induced transparency effects, Indu Krishna K N, Monika Koijam Devi, and Dibakar Roy Chowdhury, Current Applied Physics, 39, 158 (2022)`} />
          <Content data={`81) External bias dependent dynamic Terahertz propagation through BiFeO3 film, Arun Jana, Shreeya Rane, Palash Roy Choudhury, and Dibakar Roy Chowdhury, Nanotechnology, 33, 325202 (2022)`} />
          <Content data={`80) Role of Unit cell defects in terahertz topological ring resonators, Sambhu Jana, K Monika Devi, and Dibakar Roy Chowdhury, JOSA B, 39, 1590 (2022)`} />
          <Content data={`79) Broadside coupling enabled insulator to metal transition in Vanadium-dioxide based multi-layer terahertz metasurfaces, Soumyajyoti Mallick, and Dibakar Roy Chowdhury, Euro Physics Letters, 138, 55001 (2022)`} />
          <Content data={`78) Magnetospectroscopy of terahertz surface plasmons in subwavelength perforated superlattice thin-films, Subhajit Karmakar, Deepak Kumar, Ravendra Varshney, and Dibakar Roy Chowdhury, Journal of Applied Physics, 131, 223102 (2022), Cover page highlight/ feature article`} />
          <Content data={`77) Study of birefringence inside nanocrystalline Zinc Oxide thin films using terahertz spectroscopy. Rahul Godiwal, Subhash Nimanpore, Guruvandra Singh, Amit Kumar Gangwar, Ajay Verma, Dibakar Roy Chowdhury, Pretam Singh, and Mukesh Jewariya, Optical materials, 133, 112962 (2022)`} />
          <Content data={`76) Simultaneous Excitation of odd and even order resonances in plasmonic metasurfaces, Soumya Jyothi Mallick, Arun Jana, Nityananda Acharyya, and Dibakar Roy Chowdhury, Applied Optics, 61, 7435 (2022)`} />
          <Content data={`75) Polarization independent dynamic modulation of slow light characteristics via electromagnetically induced transparency in terahertz metasurfaces, Koijam Monika Devi, Arun Jana, Ajinkya Punjal, Nityananda Acharya, Shriganesh Prabhu, and Dibakar Roy Chowdhury, New Journal of Physics, 24, 093004 (2022)`} />
          <Content data={`74) Resonant Toroidal metasurface as a platform for thin film and biomaterial detection, Sukhvinder Kaur, Arun Jana, Subhajit Karmakar, Ravendra Varshney, and Dibakar Roy Chowdhury, Applied Optics, 61, 9020 (2022)`} />
          <Content data={`73) Terahertz characterizations of solution-processed Ni-doped, Cu-doped, and undoped ZnO nanoparticles, Arun Jana, Tapas Das, Shreeya Rane, Koijam Monika Devi, Asim Guchhait, and Dibakar Roy Chowdhury, Advances in Natural Sciences: Nanosciences and Nanotechnology, 13, 045009 (2022)`} />
          <Content data={`72) Temperature tunable electromagnetically induced transparency in terahertz metasurface fabricated on ferroelectric platform, Koijam Monika Devi, Arun Jana, Shreeya Rane, Palash Roy Choudhury, and Dibakar Roy Chowdhury, Journal of Physics D: Applied Physics, 55, 495103 (2022)`} />
          <Content data={`71) Coulomb interaction mediated tuning of surface plasmon resonances in terahertz hole arrays, Vaishnavi Sajeev, Arun Jana, Soumya Jyothi Mallick, Koijam Monika Devi, and Dibakar Roy Chowdhury, Journal of Physics: Photonics, 4, 045001 (2022)`} />
          <Content data={`71) Obstruction immune topological propagation, Sambhu Jana, K Monika Devi, and Dibakar Roy Chowdhury, Optics Communications, 529, 129111 (2022)`} />
          <Content data={`70) Broadband THz absorption using nanosheets of Bi2Te3 grown on a transparent conductor, Animesh Pandey, Reena Yadav, Sabyasachi Banerjee, Sumeet Kumar, Subhash Nimanpore, Mukesh Jewariya, Dibakar Roy Chowdhury, N P Lalla, and Sudhir Husale, Journal of Physical Chemistry C, Accepted (2022)`} />
          <Content
